#ifndef OTHEROtherWarehouseSelect_H
#define OTHEROtherWarehouseSelect_H
...
class OtherWarehouseSelect : public QMainWindow
{
    Q_OBJECT

public:
    OtherWarehouseSelect(QWidget *parent = 0);
...
#endif // OTHEROtherWarehouseSelect_H
